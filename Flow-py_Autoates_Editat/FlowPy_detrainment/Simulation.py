...
class Simulation(QThread):
    ...
    finished = pyqtSignal(list, list, list, list, list, list, list, list)
    ...
    def run(self):
        ...
        for i in range(len(results)):
            ...
            sl_ta_list.append(res[7])

        self.finished.emit(z_delta_list, flux_list, cc_list, z_delta_sum_list, backcalc_list, source_id_list, fp_ta_list, sl_ta_list)
